        ...
        <Grid className={styles.profileWrapper}>
            <Grid className={styles.profileFirstSection}>
                ...
                <Grid className={styles.coverLetter}>
                    ...
                    <Typography
                        variant="body1"
                        className={styles.coverLetterText}
                    >
                        Hi! Throughout my time as a Python developer, I&apos;ve
                        developed a strong foundation in Python programming,
                        enabling me to create efficient, modular, and
                        maintainable code. I&apos;ve become adept at leveraging
                        the language&apos;s versatile libraries and frameworks
                        to tackle complex tasks and deliver robust solutions.
                    </Typography>
                    <Button
                        label="Read more"
                        variant="text"
                ...
                <Grid className={styles.project}>
                    ...
                    <img
                        ...
                        alt="project"
                    />
                    {/* <Button label='Contact candidate' /> */}
                </Grid>
            </Grid>
